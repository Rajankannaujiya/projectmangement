...
import { Priority, Project, Status, Task } from '@/state/type';
...
const HomePage = () => {
  ...
  if (tasksError || !tasks || !projects) return <Error errorMessage='Error fetching data' />
  ...
  return (
    <div className="w-[100%] mx-auto h-full p-8">

      <div className="bg-white p-8 shadow rounded-lg w-[100%]">
        ...
        <div className='grid grid-cols-1 gap-4 md:grid-cols-2'>
          ...
          <div className='rounded-lg bg-white p-4 shadow dark:bg-dark-secondary md:col-span-2'>
            <h3 className='mb-4 text-lg font-semibold dark:text-white'>Your Task</h3>
